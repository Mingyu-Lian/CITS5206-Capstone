 ...
 * /api/projects:
 *   get:
 *     summary: List all active projects (Access: All roles/users)
 *     tags: [Projects]
 *     responses:
 *       200:
 ...
 * /api/projects:
 *   post:
 *     summary: Create a new project  (Access: Admin only)
 *     tags: [Projects]
 *     security:
 *       - bearerAuth: []
 *     requestBody:
 ...
 * /api/projects/{id}:
 *   get:
 *     summary: Get details of a specific project (Access: All roles/users)
 *     tags: [Projects]
 *     parameters:
 *       - in: path
 *         name: id
 ...
 * /api/projects/{id}:
 *   patch:
 *     summary: Update project details (Access: Admin only)
 *     tags: [Projects]
 *     security:
 *       - bearerAuth: []
 *     parameters:
