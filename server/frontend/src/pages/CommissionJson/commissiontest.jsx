...
import oneTable from "./OneTable.json"; 
...
// Mock API function to simulate saving data to a server
...
export default function Home() {
  ...
  return (
    <div className="p-4">
      ...
      <Modal title="Edit Cell" open={isModalOpen} onOk={handleModalOk} onCancel={handleModalCancel}>
